...
class _AgendaViewCalendarState extends SampleViewState {
  ...
  Widget build(BuildContext context) {
    print(model);
    print(model.themeData);
    if (model.themeData == null) {
      model.themeData = Theme.of(context);
    }
  ...
  void calendarTapped(CalendarTapDetails details) {
    ...
    Navigator.push<Widget>(
      ...
      MaterialPageRoute(
          builder: (BuildContext context) => AppointmentEditor(model, details.appointments[0])),
    );
  }
}
